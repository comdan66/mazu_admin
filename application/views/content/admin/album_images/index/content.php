...
<div class='panel'>
  <header>
    <h2><a href='<?php echo base_url ('admin', 'albums');?>'><?php echo $parent->title;?></a> 的照片列表</h2>
  ...
  <?php if ($objs) {
          foreach ($objs as $obj) { ?>
            <tr>
              ...
              <td class='center'>
                <figure class='_i' href='<?php echo $obj->name->url ('800w');?>'>
                  <img src='<?php echo $obj->name->url ('800w');?>' />
                  <figcaption data-description='<?php echo $obj->mini_title ();?>'><?php echo $obj->title;?></figcaption>
                </figure>
              </td>
