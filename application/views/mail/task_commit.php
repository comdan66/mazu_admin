  <div style='display: inline-block; margin: 0 auto; width: 600px; padding: 0; -moz-border-radius: 2px; -webkit-border-radius: 2px; border-radius: 2px; background-color: white;'>
    ...
    <div style='display: block; padding: 20px; color: #2e323b; border-bottom: 1px solid #e5e5e5; padding-bottom: 50px;'>
      <p style='color: #222222; margin-top: 5px; line-height: 23px;'><b><?php echo $user;?></b> 對任務「<?php echo $title;?>」留言，以下是留言概述，調整的詳細內容請您上 <a href='<?php echo $url;?>' style='display: inline-block; color: rgba(42, 90, 149, 0.7); font-weight: normal; text-decoration: none; padding: 0 2px; padding-bottom: 0; -moz-transition: all 0.3s; -o-transition: all 0.3s; -webkit-transition: all 0.3s; transition: all 0.3s;'>北港迎媽祖後台<a> 查看吧！</p>
...
<?php } ?>
      ...
      <div style='border: 1px solid #bcbcbc; padding: 5px 15px; -moz-border-radius: 3px; -webkit-border-radius: 3px; border-radius: 3px; background-color: #f5f7fa;margin-top: 15px;'>
        <p style='color: #203041; margin: 5px 0; padding: 0 5px; line-height: 25px;'><b><?php echo $user;?>：</b><span><?php echo $content;?></span></p>
      </div>

      <a href='<?php echo $url;?>' style='border: 1px solid rgba(255, 0, 0, 0.3); margin-top: 25px; padding: 10px; background-color: #ce5341; color: white; border: 1px solid #c33a2f; -moz-border-radius: 3px; -webkit-border-radius: 3px; border-radius: 3px; display: inline-block; text-decoration: inherit;'>到 北港迎媽祖後台 上查看</a>
    </div>
