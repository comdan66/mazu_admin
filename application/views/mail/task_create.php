  <div style='display: inline-block; margin: 0 auto; width: 600px; padding: 0; -moz-border-radius: 2px; -webkit-border-radius: 2px; border-radius: 2px; background-color: white;'>
    ...
    <div style='display: block; padding: 20px; color: #2e323b; border-bottom: 1px solid #e5e5e5; padding-bottom: 50px;'>
      <p style='color: #222222; margin-top: 5px; line-height: 23px;'>您有一個來自於 <b><?php echo $user;?></b> 的新任務，以下是任務概述，詳細內容請您上 <a href='<?php echo $url;?>' style='display: inline-block; color: rgba(42, 90, 149, 0.7); font-weight: normal; text-decoration: none; padding: 0 2px; padding-bottom: 0; -moz-transition: all 0.3s; -o-transition: all 0.3s; -webkit-transition: all 0.3s; transition: all 0.3s;'>北港迎媽祖後台<a> 查看詳細內容吧！</p>
