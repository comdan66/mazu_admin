 ...
 */
  ...
  $directories = array ('assets', 'temp', 'upload', 'api', 'application/cell/cache', 'application/cache/file', 'application/cache/config', 'application/cache/output', 'application/cache/model');
